...
const phrases=['¡Cuac! Hablen en equipo antes de elegir una letra.','Las vocales pueden ser buenas compañeras de aventura.','Una palabra completa para cada equipo. ¡Todos tendrán su turno!','Mira la categoría: puede ser un personaje o un lugar.','No hay reloj. ¡Piensen con calma!','Si marcan última ronda, todos jugarán la misma cantidad.','Las tildes se revelan con su vocal. ¡Cuac!','Yo camino, ustedes encuentran las letras.'];let phrase=0;let last=0;let raf=0;let pointer={x:-999,y:-999};
...
window.addEventListener('hangman-result',e=>say(e.detail==='won'?'¡Cuac! ¡Palabra resuelta, equipo!':e.detail==='lost'?'¡Ánimo! La siguiente palabra será otra aventura.':e.detail==='hit'?'¡Esa letra nos acerca a la respuesta!':'Esa no estaba. Conversen y prueben otra.')); 
})();