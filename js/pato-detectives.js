...
const phrases=['¡Cuac! Hay tres detalles que no encajan.','Lean con calma: nombres, lugares y acciones importan.','No basta con señalar el error: expliquen qué sucedió.','Pueden consultar sus Biblias mientras investigan.','Escuchen las ideas de todo el equipo.','El relato de la pantalla contiene errores a propósito.','Las referencias de la solución les ayudarán a comprobar.','Última ronda conserva el turno de todos.'];let phrase=0;let last=0;let raf=0;let pointer={x:-999,y:-999};
...
window.addEventListener('detective-result',e=>say(e.detail==='timeout'?'¡Tiempo, detectives! Expliquen sus hallazgos.':'¡Caso resuelto! Cada corrección suma.'));
})();