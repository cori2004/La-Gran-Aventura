...
const phrases=['¡Cuac! Encuentra el libro, luego el capítulo y el versículo.','No hay reloj. ¡Busca con calma y atención!','Biblias listas, ojos atentos y páginas en movimiento.','Cuando encuentren el texto, prepárense para leerlo.','¡Cuac! Yo no doy los puntos: los decide quien dirige.','Todos buscan a la vez. ¡Ánimo, equipo!','Si hay una irregularidad, pueden anular la referencia.','Una página a la vez también se llega lejos.'];let phrase=0;let last=0;let raf=0;let pointer={x:-999,y:-999};
...
window.addEventListener('sword-result',e=>say(e.detail==='winner'?'¡Cuac! Buen trabajo, equipo.':'Texto anulado. ¡Vamos a buscar otro!'));
})();