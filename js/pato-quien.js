...
const phrases=['¡Cuac! Escuchen la frase y conversen en equipo.','Dos personajes, una respuesta.','Piensen en qué estaba pasando en el relato.','Una elección representa a todo el equipo.','La referencia aparece después de responder.','Cada acierto suma diez puntos.','Son cinco frases seguidas por equipo.','Última ronda conserva el turno de todos.'];let phrase=0;let last=0;let raf=0;let pointer={x:-999,y:-999};
...
window.addEventListener('who-result',e=>say(e.detail==='hit'?'¡Cuac! ¡Reconocieron a quien habló!':e.detail==='timeout'?'¡Tiempo! Veamos quién lo dijo.':'Ahora ya conocen el contexto. ¡Siguiente frase!'));
})();