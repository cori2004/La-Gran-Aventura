...
const phrases=['¡Cuac! Quien adivina se pone de espaldas.','¡Todos pueden aportar pistas!','Solo eviten decir la respuesta o sus derivados.','Describan una escena o cuenten un detalle.','Cada acierto trae una tarjeta nueva.','¿Se atascaron? Pasen y sigan jugando.','¡Noventa segundos para sumar juntos!','Las respuestas de otro equipo serán diferentes.'];let phrase=0;let last=0;let raf=0;let pointer={x:-999,y:-999};
...
window.addEventListener('taboo-result',e=>say(e.detail==='hit'?'¡Cuac! ¡Diez puntos para el equipo!':e.detail==='timeout'?'¡Tiempo! Ahora cambiamos de equipo.':'Otra tarjeta, otra oportunidad.'));
})();