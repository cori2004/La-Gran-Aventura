...
const phrases=['¡Cuac! Verde: letra y lugar correctos.','Amarillo: la letra busca otra posición.','Sin reloj: conversen antes de probar.','Una letra repetida también necesita su pista.','La categoría les ayuda a elegir por dónde empezar.','Tienen una pequeña pista si la necesitan.','Cada intento cuenta. ¡Escuchen las ideas del equipo!','Última ronda da una oportunidad a todos.'];let phrase=0;let last=0;let raf=0;let pointer={x:-999,y:-999};
...
window.addEventListener('wordle-result',e=>say(e.detail==='won'?'¡Cuac! ¡Esa era la palabra!':e.detail==='lost'?'Una palabra más para recordar. ¡Vamos, equipo!':'Los colores tienen algo que contarles.'));
})();